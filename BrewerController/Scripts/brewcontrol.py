...
class BrewerControl:
    ...
    def serialize(self):
        return str(self.target_temp) + "," + str(self.actual_temp) + "," + str(self.duty_cycle) + "," + str(self.heater_mode.value) + "," + str(self.pump_mode.value) + "," + str(self.pump_remaining_time) + "," + str(self.heater_command_source.value)
