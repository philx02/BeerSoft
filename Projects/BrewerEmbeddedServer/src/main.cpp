...
{
  DataActiveObject< BrewControl > wBrewControl = BrewControl(std::make_unique< HeaterControl >(std::getenv("PWM_GPIO_DEVICE"), std::chrono::milliseconds(10), std::chrono::seconds(2), 15, 85, 10), std::make_unique< PumpControl >(std::getenv("PUMP_GPIO_DEVICE")));
