...
extern int32_t i2c_smbus_write_byte_data(int file, uint8_t command, uint8_t value);
...
extern int32_t i2c_smbus_read_block_data(int file, uint8_t command, uint8_t *values);
extern int32_t i2c_smbus_write_block_data(int file, uint8_t command, uint8_t length,
